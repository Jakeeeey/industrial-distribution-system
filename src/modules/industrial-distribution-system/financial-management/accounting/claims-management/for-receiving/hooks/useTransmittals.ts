//src/modules/industrial-distribution-system/financial-management/claims-management/for-receiving/hooks/useTransmittals.ts
"use client";
...
export function useTransmittals(filters: {
  q: string;
