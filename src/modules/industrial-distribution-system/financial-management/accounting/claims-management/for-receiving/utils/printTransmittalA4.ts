// src/modules/industrial-distribution-system/financial-management/claims-management/for-receiving/utils/printTransmittalA4.ts
    ...
    <div class="groupTitle">${esc(g.label)}</div>
            ...
            const itemRows = g.rows
              .map((r) => {
                ...
                const rowSupplier =
                  safeText(r.supplier_name) || supplier || "—";
