// src/modules/industrial-distribution-system/financial-management/claims-management/for-payment/components/ForPaymentPage.tsx
"use client";
...
export default function ForPaymentPage() {
  ...
  async function applyMemoFlagsForRow(
    row: TransmittalDetailRow,
    included: boolean,
  ) {
                              ...
                              <TableHead className="w-[90px] whitespace-nowrap">
                                <div className="flex items-center gap-2">
                                  <Checkbox
                                    ...
                                    disabled={
                                      dLoading || posting || totalDetails === 0
                                    }
                                  />
