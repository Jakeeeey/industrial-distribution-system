// src/modules/industrial-distribution-system/financial-management/claims-management/for-payment/providers/paymentApi.ts
...
export async function fetchCompanyProfile(): Promise<CompanyProfile | null> {
  ...
  if (!res.ok)
    throw new Error(json?.error || "Failed to fetch company profile");
