// src/modules/industrial-distribution-system/financial-management/claims-management/transmittal-history/hooks/useTransmittalHistory.ts
"use client";
...
export function useTransmittalHistory(opts?: {
  page: number;
  limit: number;
  status?: string;
}) {
