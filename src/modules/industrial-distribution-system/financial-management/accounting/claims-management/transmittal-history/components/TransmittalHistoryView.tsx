//src/modules/industrial-distribution-system/financial-management/claims-management/transmittal-history/components/TransmittalHistoryView.tsx
"use client";
...
import {
  fetchTransmittalDetails,
  fetchCompanyProfile,
} from "../../for-receiving/providers/receivingApi";
...
function ExpandedDetails({
  ...
  row: TransmittalHistoryRow;
  onPrint: (row: TransmittalHistoryRow) => void;
}) {
  return (
    <div className="px-6 py-5">
      <div className="text-sm font-semibold">
        Included CCMs ({row.details.length})
      </div>
...
export default function TransmittalHistoryView() {
  ...
  const activeStatusLabel =
    STATUS_FILTERS.find((x) => x.value === status)?.label ?? "All";
