// src/modules/industrial-distribution-system/financial-management/accounting/customers-memo/components/CustomersMemoCreationModule.tsx
            ...
            <div className="relative z-10 space-y-8">
              <div className="space-y-1">
                ...
                <div className="flex items-baseline gap-2 w-full">
                  <span className="text-2xl font-black text-blue-600 shrink-0">
                    ₱
                  </span>
