// src/modules/industrial-distribution-system/financial-management/accounting/customers-memo/components/HeaderForm.tsx
...
export const HeaderForm = React.memo(function HeaderForm({
  ...
  const salesmanOptions = useMemo(
    () =>
      salesmen.map((sl) => ({
        value: String(sl.id),
        label: `${sl.salesman_code} - ${sl.salesman_name}`,
      })),
    [salesmen],
  );
  ...
  const coaOptions = useMemo(
    () =>
      coas.map((c) => ({
        ...
        label: `${c.gl_code} - ${c.account_title}`,
      })),
    [coas],
  );
        ...
        <div className="mb-8 flex flex-col gap-2">
          ...
          <div className="flex bg-muted/40 p-1.5 rounded-[1rem] w-full max-w-sm border border-muted">
            <Button
              ...
              className={cn(
                "flex-1 h-12 font-black rounded-xl transition-all",
                balanceType === 1
            ...
            <Button
              ...
              className={cn(
                "flex-1 h-12 font-black rounded-xl transition-all",
                balanceType === 2
                  ? "bg-white shadow-md text-red-700"
                  : "text-muted-foreground hover:text-foreground hover:bg-white/50",
              )}
            >
              Debit Memo
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
          ...
          <div className="space-y-6">
            <div className="space-y-1.5">
              ...
              >
                Supplier Relationship <span className="text-red-500">*</span>
              </Label>
              <SearchableSelect
            ...
            <div className="space-y-1.5">
              <Label
                ...
                className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/70"
              >
                Assigned Salesman <span className="text-red-500">*</span>
              </Label>
              <SearchableSelect
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  value={memoNumber}
                  readOnly
                  className="h-10 bg-muted/30 font-black text-blue-600 border-dashed"
                />
              </div>
              <div className="space-y-1.5">
                <Label
                  ...
                  className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/70"
                >
                  Memo Amount <span className="text-red-500">*</span>
                </Label>
            ...
            <div className="space-y-1.5">
              <Label
                ...
                className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/70"
              >
                Chart of Account Link <span className="text-red-500">*</span>
              </Label>
              <SearchableSelect
                options={coaOptions}
                value={selectedCOA}
