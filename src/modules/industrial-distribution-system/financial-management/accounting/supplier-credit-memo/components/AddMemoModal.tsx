// src/modules/industrial-distribution-system/financial-management/accounting/supplier-credit-memo/components/AddMemoModal.tsx
...
import {
  ...
  useSuppliers,
  useChartOfAccounts,
} from "../hooks/useSupplierCreditMemo";
            ...
            <div className="max-h-52 overflow-y-auto py-1">
              {filtered.length === 0 ? (
                ...
                filtered.map((o) => (
                  ...
                  >
                    <Check
                      className={`h-3.5 w-3.5 shrink-0 ${value === o.value ? "opacity-100" : "opacity-0"}`}
                    />
                    {o.label}
                  </button>
                ))
