// src/modules/industrial-distribution-system/financial-management/accounting/supplier-credit-memo/hooks/useSupplierCreditMemo.ts
...
export function useSupplierCreditMemo() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setAllMemos(data);
      toast.success("Supplier credit memos loaded successfully", {
        id: toastId,
      });
    } catch (e) {
