...
// Donut pie chart showing EWT distribution by customer with dropdown legend.
...
export function EWTPieChart({ data, pieTotal }: EWTPieChartProps) {
  return (
    <Card className="shadow-none">
      <CardHeader className="border-b border-border/50 pb-3">
        <CardTitle className="text-sm font-semibold">EWT Distribution</CardTitle>
      </CardHeader>
