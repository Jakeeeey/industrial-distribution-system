...
export default function PricingFiltersBar(props: Props) {
    ...
    chips.push({
      ...
      onRemove: () =>
        setIds(
          setFilters,
          "price_type_ids",
          selectedPriceTypeIds.filter((x) => x !== id),
        ),
    });
  }
  ...
  if (filters.show_list_price) {
    chips.push({
      ...
      label: "List Price",
      onRemove: () =>
        setFilters((prev) => ({ ...prev, show_list_price: false })),
    });
  }
            ...
            <Popover open={supplierOpen} onOpenChange={setSupplierOpen}>
              ...
              <PopoverContent className="w-[380px] p-0" align="start">
                ...
                <div className="border-t px-3 py-2 text-xs text-muted-foreground">
                  Selecting supplier(s) will automatically show linked products
                  only.
                </div>
              </PopoverContent>
            </Popover>
              ...
              <PopoverTrigger asChild>
                ...
                >
                  <span className="truncate">
                    {labelCount(
                      "Prices",
                      selectedPriceTypeIds.length +
                        (filters.show_list_price ? 1 : 0),
                      "All Prices",
                    )}
                  </span>
                  <ChevronsUpDown className="ml-2 h-4 w-4 shrink-0 opacity-60" />
                      ...
                      {priceTypes.map((pt) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            />
                            <span className="truncate">
                              {getTierLabel(label as ProductTierKey)}
                            </span>
                          </CommandItem>
                        );
                      })}
