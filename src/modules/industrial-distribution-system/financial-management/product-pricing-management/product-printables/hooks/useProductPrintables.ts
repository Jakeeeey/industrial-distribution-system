// src/modules/industrial-distribution-system/financial-management/printables-management/product-printables/hooks/useProductPrintables.ts
"use client";
  ...
  const refresh = React.useCallback(async () => {
    ...
    try {
      ...
      for (const [groupId, variants] of groups.entries()) {
        const display =
          variants.find((v) => pickId(v.product_id) === groupId) || variants[0];
