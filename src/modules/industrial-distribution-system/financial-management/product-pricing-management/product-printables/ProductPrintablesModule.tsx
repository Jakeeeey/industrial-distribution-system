// src/modules/industrial-distribution-system/financial-management/printables-management/product-printables/ProductPrintablesModule.tsx
"use client";
...
export default function ProductPrintablesModule({
  userName,
}: {
  userName?: string;
}) {
