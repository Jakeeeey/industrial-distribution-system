// src/modules/industrial-distribution-system/financial-management/printables-management/product-printables/providers/printablesApi.ts
...
export async function getLookups(params?: {
  ...
  if (params?.supplier_scope)
    sp.set("supplier_scope", String(params.supplier_scope));
