...
export const DEFAULT_LAYOUTS: Record<string, WidgetLayout[]> = {
  ...
  personal: [
    ...
    { id: "order-status",      x: 0, y: 4,  w: 4,  h: 4,  visible: true, customSize: true },
    { id: "quick-actions",     x: 0, y: 0,  w: 4,  h: 4,  visible: true, customSize: true },
    { id: "activity-feed",     x: 0, y: 8,  w: 4,  h: 12, visible: true, customSize: true },
    { id: "weather-calendar",  x: 6, y: 0,  w: 8,  h: 4,  visible: true, customSize: true },
    { id: "cylinder-aging",    x: 0, y: 15, w: 8,  h: 4,  visible: true, customSize: true },
