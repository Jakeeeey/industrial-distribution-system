...
import { LeaveTable } from "@/modules/industrial-distribution-system/human-resource-management/employee-admin/approval/leave-request/components/LeaveTable";
import { LeaveRequestFilters } from "@/modules/industrial-distribution-system/human-resource-management/employee-admin/approval/leave-request/components/LeaveRequestFilters";
import {
  fetchLeaveRequests,
  approveOrRejectLeaveRequest,
} from "@/modules/industrial-distribution-system/human-resource-management/employee-admin/approval/leave-request/providers/fetchProvider";
import type { LeaveRequestWithUser } from "@/modules/industrial-distribution-system/human-resource-management/employee-admin/approval/leave-request/type";
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <p className="text-sm text-muted-foreground">
          ...
          <span className="font-semibold">{requests.length}</span> leave{" "}
