...
} from "../types/company-profile.schema";
                ...
                <CardContent className="p-8 space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormFieldControl
                      ...
                      name="company_name"
                      label="Company Name *"
                      placeholder="e.g. TechVision Solutions Inc."
                    />
                    <FormFieldControl
                      form={form}
                      name="company_code"
                      label="Company Code *"
                      placeholder="e.g. TVI-2024-001"
                    />
                    <FormFieldControl
                      form={form}
                      name="company_type"
                    ...
                    <FormFieldControl
                      ...
                      placeholder="Technology, Software, Innovation"
