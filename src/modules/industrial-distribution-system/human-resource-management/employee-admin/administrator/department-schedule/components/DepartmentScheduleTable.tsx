...
import { DepartmentScheduleDialog } from "@/modules/industrial-distribution-system/human-resource-management/employee-admin/administrator/department-schedule/components/DepartmentScheduleDialog";
...
export function DepartmentScheduleTable({
  ...
  const [selectedSchedule, setSelectedSchedule] =
    React.useState<DepartmentScheduleWithRelations | null>(null);

  const handleEdit = React.useCallback(
    (schedule: DepartmentScheduleWithRelations) => {
