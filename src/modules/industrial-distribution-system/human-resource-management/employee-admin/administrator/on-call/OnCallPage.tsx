...
import { ScmAdvancedFilters } from "@/modules/industrial-distribution-system/human-resource-management/employee-admin/administrator/components/filters/ScmAdvancedFilters";
import { Button } from "@/components/ui/button";
import { Plus, RefreshCw } from "lucide-react";
import { useOnCall } from "./hooks/useOnCall";
import { OnCallDialog } from "./components/OnCallDialog";
import { ScmFilterProvider } from "@/modules/industrial-distribution-system/human-resource-management/employee-admin/administrator/providers/ScmFilterProvider";
...
function OnCallContent() {
  ...
  const mappedDepartments = React.useMemo(() => {
    return departments.map(
      (d: { department_id: number | string; department_name: string }) => ({
