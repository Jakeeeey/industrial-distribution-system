...
const UserConfigurationFetchContext = createContext<
  UserConfigurationFetchContextType | undefined
>(undefined);
...
export function UserConfigurationFetchProvider({
  ...
  const fetchPage = useCallback(
    async (page: number, quiet = false, search?: string) => {
      ...
      try {
        ...
        const permissionsMap =
          await UserService.getPermissionsForUsers(userIds);
...
export function useUserConfigurationFetchContext() {
  ...
  if (!ctx)
    throw new Error("Must be used inside UserConfigurationFetchProvider");
  return ctx;
}
