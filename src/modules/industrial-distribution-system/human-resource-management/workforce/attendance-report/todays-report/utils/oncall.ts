// src/modules/industrial-distribution-system/human-resource-management/attendance-report/todays-report/utils/oncall.ts
 ...
 */
function isDayActive(date: Date, sched: Record<string, unknown>): boolean {
  const DAY_NAMES = [
    "Sunday",
    "Monday",
    "Tuesday",
