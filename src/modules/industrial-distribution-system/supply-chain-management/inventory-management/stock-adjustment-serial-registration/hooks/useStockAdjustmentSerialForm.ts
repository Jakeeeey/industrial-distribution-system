...
export function useStockAdjustmentSerialForm() {
  ...
  const fetchBranches = useCallback(async () => {
    try {
      const response = await fetch("/api/ids/scm/inventory-management/stock-adjustment-serial-registration/branches");
  ...
  const fetchProducts = useCallback(async (search?: string) => {
    ...
    try {
      const response = await fetch(
        `/api/ids/scm/inventory-management/stock-adjustment-serial-registration/products${search ? `?search=${search}` : ""}`
      );
      const result = await response.json();
  ...
  const fetchSuppliers = useCallback(async () => {
    ...
    try {
      const response = await fetch("/api/ids/scm/inventory-management/stock-adjustment-serial-registration/suppliers");
      const result = await response.json();
  ...
  const fetchProductsBySupplier = useCallback(async (supplierId: number, search?: string) => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/ids/scm/inventory-management/stock-adjustment-serial-registration/products?${params.toString()}`
      );
      const result = await response.json();
      setProducts(result.data || []);
    } catch (err) {
  ...
  const fetchBranchSerialData = useCallback(async (branchId: number) => {
    ...
    try {
      const response = await fetch(
        `/api/ids/scm/inventory-management/stock-adjustment-serial-registration/serial-products?branchId=${branchId}`
      );
  ...
  const fetchBranchInventory = useCallback(async (branchId: number) => {
    ...
    try {
      const response = await fetch(
        `/api/ids/scm/inventory-management/stock-adjustment-serial-registration/branch-inventory?branchId=${branchId}`
      );
      if (!response.ok) return;
      const result = await response.json();
  ...
  const fetchById = useCallback(async (id: number): Promise<StockAdjustmentDetail> => {
    const response = await fetch(`/api/ids/scm/inventory-management/stock-adjustment-serial-registration/${id}`);
    const result = await response.json();
  ...
  const fetchInventory = useCallback(async (productId: number, branchId: number): Promise<number> => {
    try {
      const response = await fetch(
        `/api/ids/scm/inventory-management/stock-adjustment-serial-registration/inventory?productId=${productId}&branchId=${branchId}`
      );
  ...
  const checkSerial = useCallback(async (productId: number, branchId: number): Promise<Record<string, unknown> | null> => {
    try {
      const response = await fetch(
        `/api/ids/scm/inventory-management/stock-adjustment-serial-registration/check-serial?productId=${productId}&branchId=${branchId}`
      );
  ...
  const fetchNextDocNo = useCallback(async (type: "IN" | "OUT"): Promise<string> => {
    try {
      const response = await fetch(`/api/ids/scm/inventory-management/stock-adjustment-serial-registration/next-doc-no?type=${type}`);
      const result = await response.json();
  ...
  const createAdjustment = useCallback(async (values: StockAdjustmentFormValues) => {
    const response = await fetch("/api/ids/scm/inventory-management/stock-adjustment-serial-registration", {
      method: "POST",
  ...
  const postAdjustment = useCallback(async (id: number) => {
    const response = await fetch(`/api/ids/scm/inventory-management/stock-adjustment-serial-registration/${id}/post`, {
      method: "POST",
    });
    const result = await response.json();
    if (result.error) throw new Error(result.error);
