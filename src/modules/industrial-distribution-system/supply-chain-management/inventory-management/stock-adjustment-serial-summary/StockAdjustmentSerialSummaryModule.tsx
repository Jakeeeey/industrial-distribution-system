      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-border/40 pb-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-foreground flex items-center gap-2">
            <BarChart3 className="h-6 w-6 text-primary" /> Stock Adjustment Serial Summary
          </h1>
...
export default function StockAdjustmentSerialSummaryModule() {
  return (
    <StockAdjustmentSerialSummaryProvider>
      <div className="stock-adjustment-serial-summary-module p-4 h-full bg-background/50">
