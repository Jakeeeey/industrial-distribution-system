...
import { StockAdjustmentProduct, StockAdjustmentItem } from "../../types/stock-adjustment-serial.schema";
                      ...
                      >
                        ...
                        <div className="mt-auto pt-2 text-center">
                          ...
                          {isAdded ? (
                            ...
                            <Button
                              className="w-full h-10 text-[11px] font-bold bg-primary hover:bg-primary/95 text-primary-foreground shadow-sm uppercase rounded-md transition-all duration-250"
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3">
              {cartItems.length === 0 ? (
                ...
                cartItems.map((item) => {
                  ...
                  const isItemSerial = item.is_serialized || item.unit_order === 3;
