...
import { useStockAdjustmentSerial } from "@/modules/industrial-distribution-system/supply-chain-management/inventory-management/stock-adjustment-serial-posting/hooks/useStockAdjustmentSerial";
import { StockAdjustmentForm } from "@/modules/industrial-distribution-system/supply-chain-management/inventory-management/stock-adjustment-serial-posting/components/forms/StockAdjustmentForm";
...
export default function StockAdjustmentSerialPostingModule({ mode = "creation", initialId = null }: StockAdjustmentModuleProps) {
  const { data, isLoading, error, refresh } = useStockAdjustmentSerial("Unposted");
