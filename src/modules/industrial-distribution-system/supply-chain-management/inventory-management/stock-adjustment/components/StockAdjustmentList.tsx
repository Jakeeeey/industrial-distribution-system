...
export function StockAdjustmentList({
  ...
  const isPostedStatus = (rawPosted: unknown): boolean => {
  ...
  return (
    <div className="flex flex-col gap-4 p-4 h-full overflow-hidden">
      ...
      <div className="flex flex-wrap items-end justify-between gap-4 py-3">
        ...
        <Button onClick={onCreate} className="h-10 gap-2 bg-primary hover:bg-primary/90 text-white shadow-sm font-semibold rounded-full px-6 self-end text-xs transition-all duration-300 hover:scale-[1.02]">
                    ...
                    <div className="flex items-center gap-4 flex-1">
                      ...
                      <div className="flex flex-col gap-0.5">
                        <div className="flex items-center gap-2">
                          ...
                          <Badge variant="secondary" className={`${isPosted ? 'bg-primary/10 text-primary hover:bg-primary/10' : 'bg-amber-100 text-amber-600 hover:bg-amber-100'} font-bold uppercase tracking-wider text-[10px] rounded-full px-2.5 py-0.5 border-none shadow-none`}>
                        ...
                        <div className="flex items-center gap-6 mt-1 text-sm text-muted-foreground">
                          ...
                          {isPosted && (
                            <>
                              <div className="flex flex-col">
                                <span className="text-[10px] uppercase font-bold text-primary/70">Posted At</span>
                                <span className="font-bold text-primary">
                                  {item.postedAt ? format(new Date(item.postedAt), "MMM d, yyyy, hh:mm a") : "-"}
                                </span>
                              </div>
                              <div className="flex flex-col">
                                <span className="text-[10px] uppercase font-bold text-primary/70">Posted By</span>
                                <span className="font-bold text-primary">
                                  {(() => {
