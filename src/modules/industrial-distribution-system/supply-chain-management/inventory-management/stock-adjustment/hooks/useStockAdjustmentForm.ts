...
export function useStockAdjustmentForm() {
  ...
  const fetchBranches = useCallback(async () => {
    try {
      const response = await fetch("/api/ids/scm/inventory-management/stock-adjustment/branches");
  ...
  const fetchProducts = useCallback(async (search?: string) => {
    ...
    try {
      const response = await fetch(
        `/api/ids/scm/inventory-management/stock-adjustment/products${search ? `?search=${search}` : ""}`
      );
      const result = await response.json();
  ...
  const fetchSuppliers = useCallback(async () => {
    ...
    try {
      const response = await fetch("/api/ids/scm/inventory-management/stock-adjustment/suppliers");
      const result = await response.json();
  ...
  const fetchProductsBySupplier = useCallback(async (supplierId: number, search?: string) => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/ids/scm/inventory-management/stock-adjustment/products?${params.toString()}`
      );
      const result = await response.json();
      setProducts(result.data || []);
    } catch (err) {
  ...
  const fetchBranchSerialData = useCallback(async (branchId: number) => {
    ...
    try {
      const response = await fetch(
        `/api/ids/scm/inventory-management/stock-adjustment/serial-products?branchId=${branchId}`
      );
  ...
  const fetchBranchInventory = useCallback(async (branchId: number) => {
    ...
    try {
      const response = await fetch(
        `/api/ids/scm/inventory-management/stock-adjustment/branch-inventory?branchId=${branchId}`
      );
      if (!response.ok) return;
      const result = await response.json();
  ...
  const fetchById = useCallback(async (id: number): Promise<StockAdjustmentDetail> => {
    const response = await fetch(`/api/ids/scm/inventory-management/stock-adjustment/${id}`);
    const result = await response.json();
  ...
  const fetchInventory = useCallback(async (productId: number, branchId: number): Promise<number> => {
    try {
      const response = await fetch(
        `/api/ids/scm/inventory-management/stock-adjustment/inventory?productId=${productId}&branchId=${branchId}`
      );
  ...
  const checkSerial = useCallback(async (productId: number, branchId: number): Promise<Record<string, unknown> | null> => {
    try {
      const response = await fetch(
        `/api/ids/scm/inventory-management/stock-adjustment/check-serial?productId=${productId}&branchId=${branchId}`
      );
  ...
  const validateSerialAvailability = useCallback(async (serial: string, branchId?: number): Promise<{ exists: boolean; location?: string }> => {
    try {
      ...
      const response = await fetch(
        `/api/ids/scm/inventory-management/stock-adjustment/check-available-serial?${params.toString()}`
      );
  ...
  const fetchNextDocNo = useCallback(async (type: "IN" | "OUT"): Promise<string> => {
    try {
      const response = await fetch(`/api/ids/scm/inventory-management/stock-adjustment/next-doc-no?type=${type}`);
      const result = await response.json();
  ...
  const createAdjustment = useCallback(async (values: StockAdjustmentFormValues) => {
    const response = await fetch("/api/ids/scm/inventory-management/stock-adjustment", {
      method: "POST",
