// src/modules/industrial-distribution-system/supply-chain-management/supplier-management/purchase-order-creation/components/PurchaseOrderSummary.tsx
"use client";
            ...
            <div className="space-y-3">
              ...
              <div className="text-sm border border-border rounded-lg p-5 bg-card text-card-foreground shadow-sm space-y-3 relative overflow-hidden group">
                ...
                <div className="flex justify-between items-center gap-4 relative">
                  <span className="text-muted-foreground font-medium text-[10px] uppercase tracking-wider shrink-0">
                    PO Number:
                  </span>
                  <span className="font-mono font-black text-primary text-sm sm:text-base underline decoration-dotted underline-offset-4">
                    {props.poNumber}
                  </span>
                </div>
                <div className="flex justify-between items-center gap-4 relative">
                  ...
                  <SearchableSelect
                    ...
                    value={
                      props.selectedPaymentTermId
                        ? String(props.selectedPaymentTermId)
                        : ""
                    }
                    onValueChange={(v) =>
                      props.setSelectedPaymentTermId(Number(v))
                    }
              ...
              {props.branches.length > branchesPerPage ? (
                <div className="pt-2 flex items-center justify-between">
                  ...
                  <div className="flex gap-1.5">
                    {Array.from(
                      { length: Math.min(branchTotalPages, 5) },
                      (_, i) => (
                        <div
                          key={i}
                          className={cn(
                  ...
                  <Button
                    ...
                    onClick={() =>
                      setBranchPage((p) => Math.min(branchTotalPages, p + 1))
                    }
                  >
                    Next
                  </Button>
            ...
            <div className="p-6 border border-border rounded-xl bg-card text-card-foreground shadow-md space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center text-[11px]">
                  <span className="text-foreground/70 font-black uppercase tracking-widest">
                    Gross Amount
                  </span>
                  <span className="font-black text-foreground text-sm">
                    {money.format(grossTotal)}
                  </span>
                </div>
              ...
              <div className="relative">
                <div className="flex justify-between items-end mb-4">
                  <div className="min-w-0">
                    <p className="font-black text-slate-800 dark:text-muted-foreground uppercase tracking-widest text-[9px] sm:text-[10px] mb-1">
              ...
              <div className="flex flex-col gap-3 relative mt-4">
                ...
                >
                    ...
                    <Button
                      ...
                      className={cn(
                        ...
                        locked
                          ...
                          : !disabled &&
                              "bg-primary text-primary-foreground hover:bg-primary/90 border-b-4 border-primary/20 hover:-translate-y-1 hover:shadow-primary/30 active:translate-y-0 active:border-b-0",
                        disabled &&
                          "bg-slate-200 dark:bg-slate-800 text-slate-500 dark:text-slate-400 opacity-100 cursor-not-allowed shadow-none border-2 border-slate-300 dark:border-slate-700",
                  ...
                  <AlertDialogContent className="rounded-2xl border-2 max-w-[90vw] sm:max-w-lg">
                    <AlertDialogHeader>
                      <AlertDialogTitle className="text-lg sm:text-xl font-black tracking-tight uppercase">
                        Confirm Final Submission
                      </AlertDialogTitle>
                      <AlertDialogDescription className="text-xs sm:text-sm font-medium">
                        This will record the Purchase Order into the master
                        ledger. This action is audited and irreversible.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
