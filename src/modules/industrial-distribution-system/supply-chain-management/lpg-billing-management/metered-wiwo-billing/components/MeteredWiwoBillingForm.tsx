...
export function MeteredWiwoBillingForm({ txId, onSuccess, onCancel }: Props) {
  ...
  const handleSubmit = async () => {
    const ok = await submit(isOnboarding ? "DRAFT" : "POSTED");
    if (ok) onSuccess();
  };
    ...
    <div className="space-y-6 max-w-7xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          {/* --- TAB 2: READINGS --- */}
          <div
            key={`readings-${activeTab === 'readings'}`}
        ...
        {/* --- TAB 3: REVIEW / SIDEBAR AREA --- */}
        <div
          key={`review-${activeTab === 'review'}`}
        ...
        >
          <div className="sticky top-6 space-y-6">
            ...
            {/* Mobile-only Details and Variance & Arbitration panels */}
      ...
      {/* --- MOBILE NAVIGATION FOOTER ACTIONS --- */}
      <div className="lg:hidden flex items-center justify-between mt-4 pt-6 border-t border-zinc-200 dark:border-zinc-800">
        ...
        {activeTab !== "review" ? (
          ...
          <Button variant="outline" className="w-1/3 opacity-0 pointer-events-none">_</Button>
        )}
      </div>
