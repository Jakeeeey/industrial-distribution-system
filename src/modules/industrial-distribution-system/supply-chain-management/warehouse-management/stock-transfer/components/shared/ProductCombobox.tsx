    ...
    (async () => {
      ...
      try {
        ...
        const res = await fetch(
          `/api/ids/scm/warehouse-management/stock-transfer?action=products${query}`,
        );
      ...
      <ComboboxContent>
        <ComboboxList>
          ...
          {products.map((product) => (
            <ComboboxItem key={product.product_id} value={product}>
              <div className="flex flex-col gap-0.5">
                ...
                <span className="text-[9px] text-muted-foreground uppercase font-black tracking-widest opacity-70">
                  ...
                  product.product_brand !== null
                    ? (product.product_brand as { brand_name?: string })
                        .brand_name || "GENERIC"
