...
export function ReceiveSidebar({
  orderGroups,
  selectedOrderNo,
  setSelectedOrderNo,
  loading,
      ...
      <div className="p-4 border-b border-border/50 space-y-3 bg-background/60 backdrop-blur-sm">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="pl-9 h-9 text-xs bg-background border-border/60 focus-visible:ring-indigo-500/20"
          />
        </div>
      </div>
        ...
        <div className="p-3 space-y-1.5">
          {orderGroups.length === 0 && loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-muted-foreground/40 text-center px-4">
              ...
              <p className="text-xs font-medium">No inbound shipments found.</p>
            </div>
          ) : (
            <>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isSelected
                        ...
                        : "border-border/50 bg-background hover:border-indigo-500/30 hover:bg-muted/30",
                    )}
                  >
              ...
              {hasMore && (
                <Button 
                  variant="ghost" 
                  size="sm" 
                  className="w-full text-[10px] font-semibold uppercase tracking-widest text-muted-foreground hover:text-indigo-600 mt-2" 
                  onClick={loadMore}
                  disabled={loading}
                >
