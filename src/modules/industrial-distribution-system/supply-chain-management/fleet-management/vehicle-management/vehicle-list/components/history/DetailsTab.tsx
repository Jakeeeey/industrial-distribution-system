...
function Field({
  ...
  return (
    <div
      className={["grid gap-1", alignRight ? "md:text-right" : ""].join(" ")}
    >
...
export default function DetailsTab({ vehicle }: { vehicle: VehicleRow }) {
  ...
  const purchasedDate = raw?.purchased_date
    ? fmtDateShort(raw?.purchased_date)
    : "N/A";
              ...
              <div className="mt-4 grid grid-cols-1 gap-6 md:grid-cols-12">
                <div className={imagePath ? "md:col-span-8" : "md:col-span-12"}>
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <Field
                      label="Type"
                      value={vehicle.vehicleTypeName || "N/A"}
                    />
