...
import type { CreateVehicleForm } from "@/modules/industrial-distribution-system/supply-chain-management/fleet-management/vehicle-management/vehicle-list/types";
import { uploadVehicleImage } from "@/modules/industrial-distribution-system/supply-chain-management/fleet-management/vehicle-management/vehicle-list/providers/fetchProviders";
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  className={
                    touched && !requiredOk(form.vehicleName)
                      ? "ring-1 ring-destructive"
                      : ""
                  }
              ...
              <div className="grid gap-2">
                ...
                <Select
                  value={
                    form.fuelTypeId === null ? "" : String(form.fuelTypeId)
                  }
                  onValueChange={(v) => set("fuelTypeId", v ? Number(v) : null)}
                >
                  <SelectTrigger
                    className={
                      touched && form.fuelTypeId === null
                        ? "ring-1 ring-destructive"
                        : ""
                    }
                  >
              ...
              <div className="grid gap-2">
                ...
                <Select
                  value={
                    form.engineTypeId === null ? "" : String(form.engineTypeId)
                  }
                  onValueChange={(v) =>
                    set("engineTypeId", v ? Number(v) : null)
                  }
                >
                  <SelectTrigger
                    className={
                      touched && form.engineTypeId === null
                        ? "ring-1 ring-destructive"
                        : ""
                    }
                  >
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  className={
                    touched && !requiredOk(form.maximumWeight || "")
                      ? "ring-1 ring-destructive"
                      : ""
                  }
                  placeholder="0.00"
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  className={
                    touched && !requiredOk(form.minimumLoad || "")
                      ? "ring-1 ring-destructive"
                      : ""
                  }
                  placeholder="0.00"
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  className={
                    touched && !requiredOk(form.maxLiters || "")
                      ? "ring-1 ring-destructive"
                      : ""
                  }
                  placeholder="0.00"
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  className={
                    touched && !requiredOk(form.purchasedDate || "")
                      ? "ring-1 ring-destructive"
                      : ""
                  }
                />
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  className={
                    touched && !requiredOk(form.cbmLength || "")
                      ? "ring-1 ring-destructive"
                      : ""
                  }
                  placeholder="0.00"
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  className={
                    touched && !requiredOk(form.cbmWidth || "")
                      ? "ring-1 ring-destructive"
                      : ""
                  }
                  placeholder="0.00"
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  className={
                    touched && !requiredOk(form.cbmHeight || "")
                      ? "ring-1 ring-destructive"
                      : ""
                  }
                  placeholder="0.00"
