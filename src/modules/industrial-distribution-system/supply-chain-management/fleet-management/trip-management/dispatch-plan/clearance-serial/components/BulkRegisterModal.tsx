...
export function BulkRegisterModal({
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await fetch('/api/ids/scm/fleet-management/trip-management/dispatch-plan/clearance-serial/cylinder-assets/draft', {
                method: 'POST',
                headers: {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent showCloseButton={false} className="sm:max-w-[1000px] w-[95vw] p-0 bg-background rounded-2xl border-none shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
