        ...
        <div className="flex flex-col flex-1 min-h-0 overflow-hidden px-6 pb-6 gap-4">
          ...
          <div className="space-y-2 shrink-0">
            ...
            <p className="text-xs text-muted-foreground">
              ...
              <span className="font-medium">E280F302000000010EC7C500</span>
            </p>
            ...
            <p className="text-xs text-muted-foreground">
              This field stays armed for continuous scan input. After each scan,
              it auto-focuses again so you can scan the next RFID immediately.
            </p>
          </div>
                ...
                tags.map((tag) => (
                  ...
                  >
                    <div className="min-w-0">
                      <p className="truncate font-medium">{tag.rfid_tag}</p>
                      <p className="text-xs text-muted-foreground">
