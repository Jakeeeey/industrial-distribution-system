//src/modules/industrial-distribution-system/supply-chain-management/physical-inventory-serial-management/utils/compute.ts
import type {
  CategoryRow,
...
export function requiresSerial(
  isSerialized: number | null | undefined | BufferFlagLike,
): boolean {
  return normalizeFlagValue(isSerialized) === 1;
}

export function isAllCategoryName(
  categoryName: string | null | undefined,
): boolean {
  return (categoryName ?? "").trim().toLowerCase() === "all";
}

export function isAllCategoryRow(
