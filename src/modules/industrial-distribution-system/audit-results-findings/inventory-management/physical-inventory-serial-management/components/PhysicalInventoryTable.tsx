// src/modules/industrial-distribution-system/supply-chain-management/physical-inventory-serial-management/components/PhysicalInventoryTable.tsx
"use client";
...
type Props = {
  ...
  onOpenSerial: (row: GroupedPhysicalInventoryChildRow) => void;
};
                ...
                <Table>
                  ...
                  <TableBody>
                    {group.rows.map((row) => {
                      ...
                      const hasSerialCount = row.serial_count > 0;
                      const serialButtonLabel = hasSerialCount
                        ? `View Serial (${row.serial_count})`
                        : "Scan Serial";
                        ...
                        >
                          ...
                          <TableCell className="text-center">
                            {row.requires_serial ? (
                              <Button
                                type="button"
                                variant={hasSerialCount ? "default" : "outline"}
                                size="sm"
                                className="cursor-pointer"
                                onClick={() => onOpenSerial(row)}
                                disabled={!canEdit}
                              >
