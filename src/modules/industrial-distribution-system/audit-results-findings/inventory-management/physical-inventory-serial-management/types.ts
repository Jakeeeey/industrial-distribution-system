//src/modules/industrial-distribution-system/supply-chain-management/physical-inventory-serial-management/types.ts
export type PhysicalInventoryStatus = "Pending" | "Committed" | "Cancelled";
