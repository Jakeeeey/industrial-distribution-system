...
export function OrderCancellationApprovalStats({
  ...
  return (
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
      ...
      <div className="rounded-xl border bg-card p-4 shadow-sm">
        <p className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Visible Rows</p>
        <p className="mt-1 text-2xl font-black tracking-tight">{visibleCount}</p>
      </div>
