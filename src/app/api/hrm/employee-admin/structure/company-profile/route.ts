...
import { companyProfileService } from "@/modules/industrial-distribution-system/human-resource-management/employee-admin/structrure/company-profile/services/company-profile";
import { CompanyProfileSchema } from "@/modules/industrial-distribution-system/human-resource-management/employee-admin/structrure/company-profile/types/company-profile.schema";
...
export async function PATCH(request: Request) {
  try {
    ...
    const result = await companyProfileService.updateProfile(
      company_id,
      updateData,
    );
