...
export async function GET(
    ...
    try {
        ...
        const mappedItems = items.map((sod: { product_id: unknown; ordered_quantity: number; allocated_quantity: number; unit_price: number; discount_type: string; discount_amount: number; net_amount: number }) => {
