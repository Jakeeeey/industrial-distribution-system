...
export async function POST(req: NextRequest) {
  try {
    ...
    // Resolve target folder name from formData (default to metered_billing_attachments)
    const targetFolderName = (formData.get("folder_name") as string) || "metered_billing_attachments";
