...
import TAApprovalModule from "@/modules/industrial-distribution-system/human-resource-management/employee-admin/approval/time-attendance/TAApprovalModule";
...
function buildNavUser(token: string | null | undefined) {
  ...
  const email = pickString(payload as Record<string, unknown>, [
    "email",
    "Email",
  ]);
