...
import { PhysicalInventorySerialManagementModule } from "@/modules/industrial-distribution-system/audit-results-findings/inventory-management/physical-inventory-serial-management/PhysicalInventorySerialManagementModule";
import {
    PhysicalInventoryListModule,
    type PhysicalInventoryListRow,
} from "@/modules/industrial-distribution-system/audit-results-findings/inventory-management/physical-inventory-list";
import type { PhysicalInventoryHeaderRow } from "@/modules/industrial-distribution-system/audit-results-findings/inventory-management/physical-inventory-serial-management/types";
        ...
        <div className="space-y-3 lg:space-y-4">
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:gap-4">
                ...
                <div className="min-w-0 flex-1">
                    <PhysicalInventorySerialManagementModule
                        key={activeKey}
