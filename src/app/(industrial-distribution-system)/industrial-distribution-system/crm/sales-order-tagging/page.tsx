...
import SalesOrderSerialTagging from "@/modules/industrial-distribution-system/customer-relationship-management/customer-hub/sales-order-serial-tagging";
...
export default async function Page() {
  ...
  return (
    <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
      ...
      <main className="min-h-0 min-w-0 flex-1 overflow-y-auto p-4 md:p-6 bg-background/50">
        <SalesOrderSerialTagging />
      </main>
    </div>
  );
}
