...
import { StockTransferSummaryView } from "@/modules/industrial-distribution-system/supply-chain-management/warehouse-management/stock-transfer"
                ...
                <div className="flex items-center gap-2 px-4">
                    ...
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbItem className="hidden md:block">
                                <BreadcrumbLink href="/scm/warehouse-management/stock-transfers/stock-transfer-request">Stock Transfer</BreadcrumbLink>
                            </BreadcrumbItem>
                            <BreadcrumbSeparator className="hidden md:block" />
                            <BreadcrumbItem>
