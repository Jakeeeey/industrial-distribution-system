...
import RetailTradeOutletOperationModule from "@/modules/industrial-distribution-system/customer-relationship-management/retail-trade-outlet/rto-operation/RetailTradeOutletOperationModule";
          ...
          <div className="min-w-0 overflow-hidden">
            <Breadcrumb>
              <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="#">Retail Trade Outlet</BreadcrumbLink>
                                </BreadcrumbItem>
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />
