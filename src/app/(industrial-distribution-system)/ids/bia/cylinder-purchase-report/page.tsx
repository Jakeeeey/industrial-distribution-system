...
import CylinderPurchaseReportModule from "@/modules/industrial-distribution-system/bia/cylinder-purchase-report";
...
export default async function CylinderPurchaseReportPage() {
