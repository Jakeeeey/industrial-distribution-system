...
import { ProductPricingModule } from "@/modules/industrial-distribution-system/financial-management/product-pricing-management/product-pricing";
          ...
          <div className="min-w-0 overflow-hidden">
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbItem>
                  <BreadcrumbPage>Product Pricing Matrix</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
