...
// ✅ Price Monitoring module — default export from index.ts
import PriceMonitoringModule from "@/modules/industrial-distribution-system/financial-management/product-pricing-management/price-monitoring";
  ...
  return (
    ...
    <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
          ...
          <div className="min-w-0 overflow-hidden">
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbItem>
                  <BreadcrumbPage>Price Control</BreadcrumbPage>
                </BreadcrumbItem>
                <BreadcrumbSeparator className="hidden md:block" />
                <BreadcrumbItem>
                  <BreadcrumbPage>Price Monitoring</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
      ...
      <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-2 sm:p-4">
        <PriceMonitoringModule userName={headerUser.name} />
      </main>
    </div>
  );
}
