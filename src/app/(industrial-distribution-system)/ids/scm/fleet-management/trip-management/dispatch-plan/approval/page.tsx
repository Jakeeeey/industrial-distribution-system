...
import DispatchApprovalDashboard from "@/../src/modules/industrial-distribution-system/supply-chain-management/fleet-management/trip-management/dispatch-plan/approval/DispatchApprovalClient";
          ...
          <div className="min-w-0 overflow-hidden">
            <Breadcrumb>
              <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="#">Dispatch Plan</BreadcrumbLink>
                                </BreadcrumbItem>
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />
