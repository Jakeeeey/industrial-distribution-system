...
import { StockTransferDispatchManualView } from "@/modules/industrial-distribution-system/supply-chain-management/warehouse-management/stock-transfer"
    ...
    return (
        <div className="flex h-full min-h-0 flex-col">
                ...
                <div className="flex items-center gap-2 px-4">
                    ...
                    <Breadcrumb>
                        <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="#">Stock Transfers</BreadcrumbLink>
                                </BreadcrumbItem>
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />
                                <BreadcrumbItem className="min-w-0 overflow-hidden">
                                    <BreadcrumbPage className="truncate max-w-[56vw] sm:max-w-[60vw] md:max-w-none">
                                        Stock Transfer Dispatching Manual
                                    </BreadcrumbPage>
                                </BreadcrumbItem>
                            </BreadcrumbList>
                    </Breadcrumb>
            ...
            <ScrollArea className="min-h-0 flex-1">
                <StockTransferDispatchManualView currentUser={headerUser} />
            </ScrollArea>
        </div>
    )
}
