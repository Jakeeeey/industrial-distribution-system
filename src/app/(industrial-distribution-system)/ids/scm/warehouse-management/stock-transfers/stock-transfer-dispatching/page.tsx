...
import { StockTransferDispatchView } from "@/modules/industrial-distribution-system/supply-chain-management/warehouse-management/stock-transfer"
    ...
    return (
        <div className="flex h-full min-h-0 flex-col">
            ...
            <ScrollArea className="min-h-0 flex-1">
                <StockTransferDispatchView currentUser={headerUser} />
            </ScrollArea>
        </div>
    )
}
