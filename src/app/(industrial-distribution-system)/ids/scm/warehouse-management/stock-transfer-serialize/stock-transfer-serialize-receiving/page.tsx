...
import ReceivePage from "@/modules/industrial-distribution-system/supply-chain-management/warehouse-management/stock-transfer-serialize/receive/ReceivePage"
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Breadcrumb>
                        <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="#">Stock Transfer Serial </BreadcrumbLink>
                                </BreadcrumbItem>
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />
