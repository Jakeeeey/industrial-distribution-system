// src/app/(industrial-distribution-system)/ids/scm/supplier-management/purchase-order-posting/page.tsx
...
import PostingOfProductsModule from "@/modules/industrial-distribution-system/supply-chain-management/supplier-management/purchase-order-posting-amounts/PostingOfProductsModule";
        ...
        <div className="flex h-full items-center gap-2 px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage>Posting of Purchase Order</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
