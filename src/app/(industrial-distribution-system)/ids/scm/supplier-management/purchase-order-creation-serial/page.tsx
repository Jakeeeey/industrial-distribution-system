// src/app/(industrial-distribution-system)/ids/scm/supplier-management/purchase-order-creation-serial/page.tsx
// Purpose: Next.js server page for the Cylinder Serial Return PO module.
// Route: /ids/scm/supplier-management/purchase-order-creation-serial
// Mirrors the structure of the standard purchase-order-creation page.tsx exactly.
...
// ─── JWT Helpers (identical to standard PO creation page) ────────────────────
                ...
                <div className="flex h-full items-center gap-2 px-4">
                    ...
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbItem>
                                {/* ✅ Descriptive breadcrumb — updated to reflect new tagging-only flow */}
                                <BreadcrumbPage>Cylinder Refill — Serial Tagging</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
