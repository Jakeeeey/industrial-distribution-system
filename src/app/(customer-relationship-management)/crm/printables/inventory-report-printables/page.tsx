...
import { InventoryReportModule } from "@/modules/customer-relationship-management/printables/inventory-report-printables/InventoryReportModule";
...
export default async function Page() {
  ...
  return (
    <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
      ...
      <main className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-2 sm:p-4 bg-slate-50/30">
