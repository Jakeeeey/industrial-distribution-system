...
import { PriceListPrintablesModule } from "@/modules/customer-relationship-management/printables/price-list-printables";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

export const metadata = {
    title: "Price List Printables | CRM",
    description: "Generate and print professional product price lists.",
};
...
export default async function PriceListPrintablesPage() {
