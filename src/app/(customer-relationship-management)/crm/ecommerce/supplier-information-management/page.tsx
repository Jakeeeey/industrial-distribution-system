...
import SupplierInformationManagementModule from "@/modules/customer-relationship-management/ecommerce/supplier-information-management";
...
export default async function Page() {
    ...
    return (
        ...
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
            ...
            {/* ✅ Only content scrolls inside RIGHT column - overflow-y-scroll prevents layout shift */}
            <main className="min-h-0 min-w-0 flex-1 overflow-y-scroll overflow-x-hidden p-2 sm:p-4">
                <SupplierInformationManagementModule />
            </main>
        </div>
    );
}
